  ...
  const data = [
    {
      ...
      description:
        "Bring Your NFT Project to Life. Don't wait for the competition to leapfrog you.",
      buttonText: "Create",
    },
    {
      image: sell2,
      title: "Add your NFTs",
      description:
        "All your NFT's in one place. Grow your collection witout any worries.",
      buttonText: "Add NFT",
    },
    {
      image: sell3,
      ...
      description:
        "Easiest way to sell your NFT to the world's largest customer base.",
      buttonText: "Sell Now",
    },
  ];
  return (
